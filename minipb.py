...
class Wire(object):
    ...
    def __init__(self, fmt):
        self.logger = getLogger('minipb.Wire')
    ...
    def _encode_wire(self, stuff, fmtable=None):
        ...
        for fmt in fmtable:
            ...
            for field_id in range(field_id_start, field_id_start + repeat):
                ...
                self.logger.debug('_encode_wire(): Encoding field %d type %s prefix %s'%
    ...
    def _encode_field(self, field_type, field_data, subcontent=None):
        ...
        """
        self.logger.debug('_encode_field(): pytype %s values %s'%
    ...
    def _decode_wire(self, buf, subfmt=None):
        ...
        for fmt in subfmt:
            ...
            for field_id in range(field_id_start, field_id_start + repeat):
                self.logger.debug(
                    '_decode_wire(): processing field %d type %s' % (field_id, field_type)
                )
...
class RawWire(Wire):
    ...
    '''
    def __init__(self):
        self.logger = getLogger('minipb.RawWire')
